...
import _RNTextStylePropTypes from 'react-native/Libraries/DeprecatedPropTypes/DeprecatedText/TextStylePropTypes'
  ...
  cssToRNStyle (css, styleset) {
    ...
    return Object.keys(css)
      ...
      .map(([key, value]) => {
        ...
        const testStyle = {}
        testStyle[key] = value
        if (PropTypes.checkPropTypes(styleProps[key], testStyle, key, 'prop')) {
